...
export default {
  // Return token string
  create: data => new Promise((resolve, reject) => jwt.sign({ data, }, secret(), Object.assign({}, signOptions, { jwtid: uuidv4() }), (e, token) => e ? reject(e) : resolve(token))),
  // Return data object
  ...
  refresh: token => new Promise((resolve, reject) => {
    jwt.verify(token, secret(), verifyOptions, (e, payload) => {
      ...
      const newSignOptions = Object.assign({}, signOptions, { jwtid: uuidv4() })
